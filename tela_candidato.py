...
# Comentários expandindo as variáveis abreviadas:
# cpf_in: TextInput para o CPF do candidato
# nome_in: TextInput para o nome do candidato
# email_in: TextInput para o email do candidato
# tel_in: TextInput para o telefone do candidato
# pret_in: FloatInput para a pretensão salarial do candidato
# end_in: TextInput para o endereço do candidato
# nasc_in: DatePicker para a data de nascimento do candidato
# curr_in: TextAreaInput para o currículo do candidato
# msg: Markdown para exibir mensagens gerais
# cand_df: DataFrame para exibir candidaturas
# cursos_insc_df: DataFrame para exibir cursos inscritos
# den_df: DataFrame para exibir denúncias
# grupos_cand_df: DataFrame para exibir grupos vulneráveis do candidato
# _curr_cpf: Variável interna para armazenar o CPF do candidato atualmente buscado
# vagas_disp_sel: Select para selecionar vagas disponíveis
# btn_ins_vaga: Botão para inscrever-se em uma vaga
# msg_ins_vaga: Markdown para mensagens de inscrição em vaga
# cand_id_canc_in: TextInput para o ID da vaga a cancelar candidatura
# btn_canc_cand: Botão para cancelar candidatura
# msg_canc_cand: Markdown para mensagens de cancelamento de candidatura
# cursos_disp_sel: Select para selecionar cursos disponíveis
# btn_ins_curso: Botão para inscrever-se em um curso
# msg_ins_curso: Markdown para mensagens de inscrição em curso
# insc_curso_id_ger_in: TextInput para o ID do curso a gerenciar inscrição
# status_curso_upd_sel: Select para atualizar o status do curso
# btn_upd_status_curso: Botão para atualizar o status do curso
# btn_canc_insc_curso: Botão para cancelar inscrição no curso
# msg_ger_curso: Markdown para mensagens de gerenciamento de curso
# den_vaga_sel: Select para selecionar vaga relacionada à denúncia
# den_desc_in: TextAreaInput para a descrição da denúncia
# btn_fazer_den: Botão para fazer denúncia
# msg_den: Markdown para mensagens de denúncia
# grupos_vul_sel: Select para selecionar grupos vulneráveis
# comp_grupo_in: TextInput para o comprovante do grupo
# btn_add_grupo: Botão para inscrever-se em um grupo
# msg_grupos: Markdown para mensagens de grupos
# grupo_id_rem_in: TextInput para o ID do grupo a sair
# btn_rem_grupo: Botão para sair de um grupo
# hab_campos_cand: Função para habilitar/desabilitar campos do candidato
# carregar_vagas_disp: Função para carregar vagas disponíveis
# carregar_cursos_disp: Função para carregar cursos disponíveis
# carregar_grupos_vul: Função para carregar grupos vulneráveis
# _carregar_cand_data: Função auxiliar para carregar dados de candidaturas
# _carregar_cursos_insc_data: Função auxiliar para carregar dados de cursos inscritos
# _carregar_den_data: Função auxiliar para carregar dados de denúncias
# _carregar_grupos_cand_data: Função auxiliar para carregar dados de grupos do candidato
# ins_vaga: Função para inscrever na vaga
# canc_cand: Função para cancelar candidatura
# ins_curso: Função para inscrever em curso
# alt_status_curso: Função para alterar status do curso
# canc_insc_curso: Função para cancelar inscrição no curso
# fazer_den: Função para fazer denúncia
# add_grupo_cand: Função para adicionar grupo ao candidato
# rem_grupo_cand: Função para remover grupo do candidato
# criar_cand: Função para criar candidato
# buscar_cand: Função para buscar candidato
# atualizar_cand: Função para atualizar candidato
# deletar_cand: Função para deletar candidato
# limpar_campos_cand: Função para limpar campos do candidato
# btn_criar_cand: Botão para criar candidato
# btn_buscar_cand: Botão para buscar candidato
# btn_atualizar_cand: Botão para atualizar candidato
# btn_deletar_cand: Botão para deletar candidato
# btn_limpar_campos_cand: Botão para limpar campos do candidato
# btns_crud_cand: Linha de botões CRUD do candidato
# abas_ext: Abas extras para informações relacionadas
